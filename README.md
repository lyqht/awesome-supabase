...
- [CiteMe](https://citeme.app/) - AI-powered academic citation generator that searches 8+ databases and formats references in 40+ styles. Uses Supabase Auth, DB with RLS, and real-time subscriptions.
