...
- [ShopSavvy](https://github.com/shopsavvy/supabase-shopsavvy) - Supabase Edge Functions for product search, real-time pricing, and price history via the ShopSavvy Data API.
