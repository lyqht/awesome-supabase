...
- [Vedika API](https://vedika.io) - Vedic astrology intelligence API with 108+ endpoints, AI chatbot, and multilingual support. Perfect complement to Supabase for building astrology-powered apps.
